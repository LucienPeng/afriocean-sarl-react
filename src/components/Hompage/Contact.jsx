...
export const Contact = (props) => {
    ...
    const CONTACT_INFO = [
        ...
        { title: 'Email', detail: 'afriocean.sarl@gmail.com', surplusDetail: 'karima.afriocean@gmail.com', icon: <EmailIcon sx={{ color: 'common.white', fontSize: '40px' }} /> },
    ];
        ...
        <Stack component='div' ref={contactRef} minHeight='70vh' sx={{ bgcolor: 'primary.dark' }}>
            <Box alignItems='center' display='flex' flexDirection='column' my={5}>
                ...
                <Grid container spacing={5} direction='row' justifyContent='center' alignItems='center'>
                    ...
                    <Grid data-aos="zoom-in-down" item xs={11} md={5} justifyContent='center' height='30vh'>
